...
namespace LayoutTest.ViewModels
{
    public class ProfilePageViewModel : ViewModelBase
    {
        ...
        public ProfilePageViewModel(string param)
        {
            ...
            AvatarImg = ImageSource.FromResource("LayoutTest.Images.Android-icon-m.png");

            ScoreImg = ImageSource.FromResource("LayoutTest.Images.progress-default.png");
            PostureImg = ImageSource.FromResource("LayoutTest.Images.Posture-defaut.png");
            WarningImg = ImageSource.FromResource("LayoutTest.Images.Warning-icon-64.png");
