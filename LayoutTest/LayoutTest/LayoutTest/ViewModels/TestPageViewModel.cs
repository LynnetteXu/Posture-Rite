...
namespace LayoutTest.ViewModels
{
    class TestPageViewModel: ViewModelBase
    {
        ...
        public TestPageViewModel(INavigationService navService)
        {
            ...
            RingImg = ImageSource.FromResource("LayoutTest.Images.multimedia.png");
            VibraImg = ImageSource.FromResource("LayoutTest.Images.cell-phone-vibration.png");
